...
/**
 * Performance test for the DevChargingTool entity.
 */
class DevChargingToolGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the DevChargingTool entity")
