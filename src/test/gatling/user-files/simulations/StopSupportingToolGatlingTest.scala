...
/**
 * Performance test for the StopSupportingTool entity.
 */
class StopSupportingToolGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the StopSupportingTool entity")
