...
/**
 * Performance test for the StopDrillingTool entity.
 */
class StopDrillingToolGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the StopDrillingTool entity")
