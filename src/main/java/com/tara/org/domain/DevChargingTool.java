 ...
 */
@Entity
@Table(name = "dev_charging_tool")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "devchargingtool")
public class DevChargingTool implements Serializable {
    ...
    @Column(name = "tesded_explosive_type")
    private String tesdedExplosiveType;
    ...
    public DevChargingTool name(String name) {
        this.name = name;
        return this;
    }
    ...
    public DevChargingTool model(String model) {
        this.model = model;
        return this;
    }
    ...
    public DevChargingTool technologyType(String technologyType) {
    ...
    public DevChargingTool trl(Integer trl) {
        this.trl = trl;
        return this;
    }
    ...
    public DevChargingTool photo(byte[] photo) {
        this.photo = photo;
        return this;
    }
    ...
    public DevChargingTool photoContentType(String photoContentType) {
    ...
    public DevChargingTool datasheet(byte[] datasheet) {
    ...
    public DevChargingTool datasheetContentType(String datasheetContentType) {
    ...
    public DevChargingTool hoseLength(Float hoseLength) {
    ...
    public DevChargingTool testedHoseLength(Float testedHoseLength) {
    ...
    public DevChargingTool holeDiameter(Float holeDiameter) {
    ...
    public DevChargingTool testedHoleDiameter(Float testedHoleDiameter) {
    ...
    public DevChargingTool explosiveType(String explosiveType) {
    ...
    public String getTesdedExplosiveType() {
        return tesdedExplosiveType;
    }

    public DevChargingTool tesdedExplosiveType(String tesdedExplosiveType) {
        this.tesdedExplosiveType = tesdedExplosiveType;
        return this;
    }

    public void setTesdedExplosiveType(String tesdedExplosiveType) {
        this.tesdedExplosiveType = tesdedExplosiveType;
    }
    ...
    public DevChargingTool tankCapacity(Float tankCapacity) {
    ...
    public DevChargingTool testedTankCapacity(Float testedTankCapacity) {
    ...
    public DevChargingTool height(Float height) {
        this.height = height;
        return this;
    }
    ...
    public DevChargingTool testedHeight(Float testedHeight) {
    ...
    public DevChargingTool weight(Float weight) {
        this.weight = weight;
        return this;
    }
    ...
    public DevChargingTool testedWeight(Float testedWeight) {
    ...
    public DevChargingTool length(Float length) {
        this.length = length;
        return this;
    }
    ...
    public DevChargingTool testedLength(Float testedLength) {
    ...
    public DevChargingTool rpmOutput(Float rpmOutput) {
    ...
    public DevChargingTool testedRpmOutput(Float testedRpmOutput) {
    ...
    public DevChargingTool torque(Float torque) {
        this.torque = torque;
        return this;
    }
    ...
    public DevChargingTool testedTorque(Float testedTorque) {
    ...
    public DevChargingTool tankRange(String tankRange) {
    ...
    public DevChargingTool testedTankRange(String testedTankRange) {
    ...
    public DevChargingTool fuelConsumption(Float fuelConsumption) {
    ...
    public DevChargingTool testedFuelConsumption(Float testedFuelConsumption) {
    ...
    public DevChargingTool availability(Float availability) {
    ...
    public DevChargingTool testedAvailability(Float testedAvailability) {
    ...
    public DevChargingTool operatingCostPerTonne(Float operatingCostPerTonne) {
    ...
    public DevChargingTool testedOperatingCostPerTonne(Float testedOperatingCostPerTonne) {
    ...
    public DevChargingTool fuelConsumptionPerExplosiveKgCharged(Float fuelConsumptionPerExplosiveKgCharged) {
    ...
    public DevChargingTool testedFuelConsumptionPerExplosiveKgCharged(Float testedFuelConsumptionPerExplosiveKgCharged) {
    ...
    public DevChargingTool controlSystem(String controlSystem) {
    ...
    public DevChargingTool testedControlSystem(String testedControlSystem) {
    ...
    public DevChargingTool cycleTime(Float cycleTime) {
    ...
    public DevChargingTool testedCycleTime(Float testedCycleTime) {
    ...
    public DevChargingTool turningRadiusInner(Float turningRadiusInner) {
    ...
    public DevChargingTool testedTurningRadiusInner(Float testedTurningRadiusInner) {
    ...
    public DevChargingTool turningRadiusOuter(Float turningRadiusOuter) {
    ...
    public DevChargingTool testedTurningRadiusOuter(Float testedTurningRadiusOuter) {
    ...
    public DevChargingTool lubricationType(LubricationType lubricationType) {
    ...
    public DevChargingTool testedLubricationType(LubricationType testedLubricationType) {
    ...
    public DevChargingTool temperatureAtAmbient(Float temperatureAtAmbient) {
    ...
    public DevChargingTool testedTemperatureAtAmbient(Float testedTemperatureAtAmbient) {
    ...
    public DevChargingTool observations1(String observations1) {
    ...
    public DevChargingTool testedObservations1(String testedObservations1) {
    ...
    public DevChargingTool observations2(String observations2) {
    ...
    public DevChargingTool testedObservations2(String testedObservations2) {
    ...
    public DevChargingTool observations3(String observations3) {
    ...
    public DevChargingTool testedObservations3(String testedObservations3) {
    ...
    public DevChargingTool observations4(String observations4) {
    ...
    public DevChargingTool testedObservations4(String testedObservations4) {
    ...
    public DevChargingTool observations5(String observations5) {
    ...
    public DevChargingTool testedObservations5(String testedObservations5) {
    ...
    public DevChargingTool observations6(String observations6) {
    ...
    public DevChargingTool testedObservations6(String testedObservations6) {
    ...
    public DevChargingTool operators_Comments(String operators_Comments) {
    ...
    public DevChargingTool testedOperators_Comments(String testedOperators_Comments) {
    ...
    public DevChargingTool oemName(Company company) {
    ...
    public DevChargingTool addedBy(User user) {
        this.addedBy = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        DevChargingTool devChargingTool = (DevChargingTool) o;
        if (devChargingTool.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), devChargingTool.getId());
    }
    ...
    public String toString() {
        return "DevChargingTool{" +
            ...
            ", tesdedExplosiveType='" + getTesdedExplosiveType() + "'" +
