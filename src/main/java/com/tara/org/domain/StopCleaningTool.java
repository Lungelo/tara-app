 ...
 */
@Entity
@Table(name = "stop_cleaning_tool")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "stopcleaningtool")
public class StopCleaningTool implements Serializable {
    ...
    @Column(name = "tested_fuel_consumption_per_tonne_hauled")
    private Float testedFuelConsumptionPerTonneHauled;
    ...
    @Column(name = "turning_radius_inner")
    ...
    public StopCleaningTool name(String name) {
        this.name = name;
        return this;
    }
    ...
    public StopCleaningTool model(String model) {
        this.model = model;
        return this;
    }
    ...
    public StopCleaningTool technologyType(String technologyType) {
    ...
    public StopCleaningTool trl(Integer trl) {
        this.trl = trl;
        return this;
    }
    ...
    public StopCleaningTool photo(byte[] photo) {
        this.photo = photo;
        return this;
    }
    ...
    public StopCleaningTool photoContentType(String photoContentType) {
    ...
    public StopCleaningTool datasheet(byte[] datasheet) {
    ...
    public StopCleaningTool datasheetContentType(String datasheetContentType) {
    ...
    public StopCleaningTool trammingCapacity(Float trammingCapacity) {
    ...
    public StopCleaningTool testedTrammingCapacity(Float testedTrammingCapacity) {
    ...
    public StopCleaningTool height(Float height) {
        this.height = height;
        return this;
    }
    ...
    public StopCleaningTool testedHeight(Float testedHeight) {
    ...
    public StopCleaningTool weight(Float weight) {
        this.weight = weight;
        return this;
    }
    ...
    public StopCleaningTool testedWeight(Float testedWeight) {
    ...
    public StopCleaningTool length(Float length) {
        this.length = length;
        return this;
    }
    ...
    public StopCleaningTool testedLength(Float testedLength) {
    ...
    public StopCleaningTool rpmOutput(Float rpmOutput) {
    ...
    public StopCleaningTool testedRpmOutput(Float testedRpmOutput) {
    ...
    public StopCleaningTool torque(Float torque) {
        this.torque = torque;
        return this;
    }
    ...
    public StopCleaningTool testedTorque(Float testedTorque) {
    ...
    public StopCleaningTool tankRange(String tankRange) {
    ...
    public StopCleaningTool testedTankRange(String testedTankRange) {
    ...
    public StopCleaningTool fuelConsumption(Float fuelConsumption) {
    ...
    public StopCleaningTool testedFuelConsumption(Float testedFuelConsumption) {
    ...
    public StopCleaningTool availability(Float availability) {
    ...
    public StopCleaningTool testedAvailability(Float testedAvailability) {
    ...
    public StopCleaningTool operatingCostPerTonne(Float operatingCostPerTonne) {
    ...
    public StopCleaningTool testedOperatingCostPerTonne(Float testedOperatingCostPerTonne) {
    ...
    public StopCleaningTool fuelConsumptionPerTonneHauled(Float fuelConsumptionPerTonneHauled) {
    ...
    public Float getTestedFuelConsumptionPerTonneHauled() {
        return testedFuelConsumptionPerTonneHauled;
    }

    public StopCleaningTool testedFuelConsumptionPerTonneHauled(Float testedFuelConsumptionPerTonneHauled) {
        this.testedFuelConsumptionPerTonneHauled = testedFuelConsumptionPerTonneHauled;
        return this;
    }

    public void setTestedFuelConsumptionPerTonneHauled(Float testedFuelConsumptionPerTonneHauled) {
        this.testedFuelConsumptionPerTonneHauled = testedFuelConsumptionPerTonneHauled;
    }
    ...
    public StopCleaningTool controlSystem(String controlSystem) {
    ...
    public StopCleaningTool testedControlSystem(String testedControlSystem) {
    ...
    public StopCleaningTool cycleTime(Float cycleTime) {
    ...
    public StopCleaningTool testedCycleTime(Float testedCycleTime) {
    ...
    public StopCleaningTool turningRadiusInner(Float turningRadiusInner) {
    ...
    public StopCleaningTool testedTurningRadiusInner(Float testedTurningRadiusInner) {
    ...
    public StopCleaningTool turningRadiusOuter(Float turningRadiusOuter) {
    ...
    public StopCleaningTool testedTurningRadiusOuter(Float testedTurningRadiusOuter) {
    ...
    public StopCleaningTool lubricationType(LubricationType lubricationType) {
    ...
    public StopCleaningTool testedLubricationType(LubricationType testedLubricationType) {
    ...
    public StopCleaningTool temperatureAtAmbient(Float temperatureAtAmbient) {
    ...
    public StopCleaningTool testedTemperatureAtAmbient(Float testedTemperatureAtAmbient) {
    ...
    public StopCleaningTool observations1(String observations1) {
    ...
    public StopCleaningTool testedObservations1(String testedObservations1) {
    ...
    public StopCleaningTool observations2(String observations2) {
    ...
    public StopCleaningTool testedObservations2(String testedObservations2) {
    ...
    public StopCleaningTool observations3(String observations3) {
    ...
    public StopCleaningTool testedObservations3(String testedObservations3) {
    ...
    public StopCleaningTool observations4(String observations4) {
    ...
    public StopCleaningTool testedObservations4(String testedObservations4) {
    ...
    public StopCleaningTool observations5(String observations5) {
    ...
    public StopCleaningTool testedObservations5(String testedObservations5) {
    ...
    public StopCleaningTool observations6(String observations6) {
    ...
    public StopCleaningTool testedObservations6(String testedObservations6) {
    ...
    public StopCleaningTool operators_Comments(String operators_Comments) {
    ...
    public StopCleaningTool testedOperators_Comments(String testedOperators_Comments) {
    ...
    public StopCleaningTool oemName(Company company) {
    ...
    public StopCleaningTool addedBy(User user) {
        this.addedBy = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        StopCleaningTool stopCleaningTool = (StopCleaningTool) o;
        if (stopCleaningTool.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), stopCleaningTool.getId());
    }
    ...
    public String toString() {
        return "StopCleaningTool{" +
            ...
            ", testedFuelConsumptionPerTonneHauled='" + getTestedFuelConsumptionPerTonneHauled() + "'" +
