 ...
 */
@Entity
@Table(name = "dev_drilling_tool")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "devdrillingtool")
public class DevDrillingTool implements Serializable {
    ...
    @NotNull
    @Column(name = "working_height", nullable = false)
    private Float workingHeight;

    @Column(name = "tested_working_height")
    private Float testedWorkingHeight;
    ...
    @NotNull
    @Column(name = "number_of_boom", nullable = false)
    private Float numberOfBoom;

    @Column(name = "tested_number_of_boom")
    private Float testedNumberOfBoom;

    @NotNull
    @Column(name = "typer_of_boom", nullable = false)
    private String typerOfBoom;

    @Column(name = "tested_typer_of_boom")
    private String testedTyperOfBoom;
    ...
    public DevDrillingTool name(String name) {
        this.name = name;
        return this;
    }
    ...
    public DevDrillingTool model(String model) {
        this.model = model;
        return this;
    }
    ...
    public DevDrillingTool technologyType(String technologyType) {
    ...
    public DevDrillingTool trl(Integer trl) {
        this.trl = trl;
        return this;
    }
    ...
    public DevDrillingTool photo(byte[] photo) {
        this.photo = photo;
        return this;
    }
    ...
    public DevDrillingTool photoContentType(String photoContentType) {
    ...
    public DevDrillingTool datasheet(byte[] datasheet) {
    ...
    public DevDrillingTool datasheetContentType(String datasheetContentType) {
    ...
    public DevDrillingTool weight(Float weight) {
        this.weight = weight;
        return this;
    }
    ...
    public DevDrillingTool testedWeight(Float testedWeight) {
    ...
    public DevDrillingTool length(Float length) {
        this.length = length;
        return this;
    }
    ...
    public DevDrillingTool testedLength(Float testedLength) {
    ...
    public DevDrillingTool drillingRate(Float drillingRate) {
    ...
    public DevDrillingTool testedDrillingRate(Float testedDrillingRate) {
    ...
    public DevDrillingTool noiseLevel(Float noiseLevel) {
    ...
    public DevDrillingTool testedNoiseLevel(Float testedNoiseLevel) {
    ...
    public DevDrillingTool settingUpTime(Float settingUpTime) {
    ...
    public DevDrillingTool testedSettingUpTime(Float testedSettingUpTime) {
    ...
    public DevDrillingTool dismantlingTime(Float dismantlingTime) {
    ...
    public DevDrillingTool testedDismantlingTime(Float testedDismantlingTime) {
    ...
    public DevDrillingTool waterUsePerMetreDrilled(Float waterUsePerMetreDrilled) {
    ...
    public DevDrillingTool testedWaterUsePerMetreDrilled(Float testedWaterUsePerMetreDrilled) {
    ...
    public DevDrillingTool availability(Float availability) {
    ...
    public DevDrillingTool testedAvailability(Float testedAvailability) {
    ...
    public DevDrillingTool costPerMeterDrilled(Float costPerMeterDrilled) {
    ...
    public DevDrillingTool testedCostPerMeterDrilled(Float testedCostPerMeterDrilled) {
    ...
    public DevDrillingTool holeSizeRange(String holeSizeRange) {
    ...
    public DevDrillingTool testedHoleSizeRange(String testedHoleSizeRange) {
    ...
    public DevDrillingTool powerSource(String powerSource) {
    ...
    public DevDrillingTool testedPowerSource(String testedPowerSource) {
    ...
    public DevDrillingTool powerRating(Float powerRating) {
    ...
    public DevDrillingTool testedPowerRating(Float testedPowerRating) {
    ...
    public DevDrillingTool cost(BigDecimal cost) {
        this.cost = cost;
        return this;
    }
    ...
    public DevDrillingTool testedCost(BigDecimal testedCost) {
    ...
    public DevDrillingTool trammingSpeed(Float trammingSpeed) {
    ...
    public DevDrillingTool testedTrammingSpeed(Float testedTrammingSpeed) {
    ...
    public DevDrillingTool workingHeight(Float workingHeight) {
        this.workingHeight = workingHeight;
        return this;
    }

    public void setWorkingHeight(Float workingHeight) {
        this.workingHeight = workingHeight;
    }

    public Float getTestedWorkingHeight() {
        return testedWorkingHeight;
    }

    public DevDrillingTool testedWorkingHeight(Float testedWorkingHeight) {
        this.testedWorkingHeight = testedWorkingHeight;
        return this;
    }

    public void setTestedWorkingHeight(Float testedWorkingHeight) {
        this.testedWorkingHeight = testedWorkingHeight;
    }
    ...
    public DevDrillingTool gradeability(Float gradeability) {
    ...
    public DevDrillingTool testedGradeability(Float testedGradeability) {
    ...
    public Float getNumberOfBoom() {
        return numberOfBoom;
    }

    public DevDrillingTool numberOfBoom(Float numberOfBoom) {
        this.numberOfBoom = numberOfBoom;
        return this;
    }

    public void setNumberOfBoom(Float numberOfBoom) {
        this.numberOfBoom = numberOfBoom;
    }

    public Float getTestedNumberOfBoom() {
        return testedNumberOfBoom;
    }

    public DevDrillingTool testedNumberOfBoom(Float testedNumberOfBoom) {
        this.testedNumberOfBoom = testedNumberOfBoom;
        return this;
    }

    public void setTestedNumberOfBoom(Float testedNumberOfBoom) {
        this.testedNumberOfBoom = testedNumberOfBoom;
    }

    public String getTyperOfBoom() {
        return typerOfBoom;
    }

    public DevDrillingTool typerOfBoom(String typerOfBoom) {
        this.typerOfBoom = typerOfBoom;
        return this;
    }

    public void setTyperOfBoom(String typerOfBoom) {
        this.typerOfBoom = typerOfBoom;
    }

    public String getTestedTyperOfBoom() {
        return testedTyperOfBoom;
    }

    public DevDrillingTool testedTyperOfBoom(String testedTyperOfBoom) {
        this.testedTyperOfBoom = testedTyperOfBoom;
        return this;
    }

    public void setTestedTyperOfBoom(String testedTyperOfBoom) {
        this.testedTyperOfBoom = testedTyperOfBoom;
    }
    ...
    public DevDrillingTool outerTurningRadius(Float outerTurningRadius) {
    ...
    public DevDrillingTool testedOuterTurningRadius(Float testedOuterTurningRadius) {
    ...
    public DevDrillingTool innerTurningRadius(Float innerTurningRadius) {
    ...
    public DevDrillingTool testedInnerTurningRadius(Float testedInnerTurningRadius) {
    ...
    public DevDrillingTool observations1(String observations1) {
    ...
    public DevDrillingTool testedObservations1(String testedObservations1) {
    ...
    public DevDrillingTool observations2(String observations2) {
    ...
    public DevDrillingTool testedObservations2(String testedObservations2) {
    ...
    public DevDrillingTool observations3(String observations3) {
    ...
    public DevDrillingTool testedObservations3(String testedObservations3) {
    ...
    public DevDrillingTool observations4(String observations4) {
    ...
    public DevDrillingTool testedObservations4(String testedObservations4) {
    ...
    public DevDrillingTool observations5(String observations5) {
    ...
    public DevDrillingTool testedObservations5(String testedObservations5) {
    ...
    public DevDrillingTool observations6(String observations6) {
    ...
    public DevDrillingTool testedObservations6(String testedObservations6) {
    ...
    public DevDrillingTool operators_Comments(String operators_Comments) {
    ...
    public DevDrillingTool testedOperators_Comments(String testedOperators_Comments) {
    ...
    public DevDrillingTool oemName(Company company) {
    ...
    public DevDrillingTool addedBy(User user) {
        this.addedBy = user;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        DevDrillingTool devDrillingTool = (DevDrillingTool) o;
        if (devDrillingTool.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), devDrillingTool.getId());
    }
    ...
    public String toString() {
        return "DevDrillingTool{" +
            ...
            ", workingHeight='" + getWorkingHeight() + "'" +
            ", testedWorkingHeight='" + getTestedWorkingHeight() + "'" +
            ", gradeability='" + getGradeability() + "'" +
            ", testedGradeability='" + getTestedGradeability() + "'" +
            ", numberOfBoom='" + getNumberOfBoom() + "'" +
            ", testedNumberOfBoom='" + getTestedNumberOfBoom() + "'" +
            ", typerOfBoom='" + getTyperOfBoom() + "'" +
            ", testedTyperOfBoom='" + getTestedTyperOfBoom() + "'" +
